...
import com.examples.quakereport.Earthquake;
...
*/
    ...
    private QueryUtils() {
     ...
     public static String makeHttpRequest(String path){
        String jsonResponse="";
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String path) {
        ...
        try {
            ...
            JSONObject baseJsonResponse= new JSONObject(makeHttpRequest(path));
            ...
            Log.e(TAG, "Problem parsing the earthquake JSON results",exception);
        }
